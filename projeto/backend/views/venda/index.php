        ...
        <div class="table-responsive">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <div class="col-sm-5">
                            <h2>Painel de <b>Vendas</b></h2>
                        </div>
                        <div class="col-sm-7">
                            <?= Html::a('<i class="material-icons">&#xE147;</i><span>Nova venda</span>', ['create'], ['class' => 'btn btn-secondary'])?>
                        </div>
                    </div>
                </div>
                <table class="table table-striped table-hover">
                    ...
                    <tr>
                        <td><?= $venda->idUser ?></td>
                        <td><a href="#"><?= Html::a($venda->titulo, ['venda/view', 'id' => $venda->id], ['class' => 'settings','title'=>$venda->id, 'data-toggle'=>'tooltip']); ?></a></td>
                        <td><?= $venda->preco ?> </td>
                        <td>
