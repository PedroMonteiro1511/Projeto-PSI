...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a href="<?=\yii\helpers\Url::home()?>" class="nav-link">Gestão de Utilizadores</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
        ...
        <li class="nav-item dropdown">
            ...
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                ...
                <li><a href="<?= Html::a('Sign out', ['user/index'], ['data-method' => 'post', 'class' => 'dropdown-item']) ?>" class="dropdown-item">Some other action</a></li>
                <li><?= Html::a('Sign out', ['user/index'], ['data-method' => 'post', 'class' => 'dropdown-item']) ?></li>
